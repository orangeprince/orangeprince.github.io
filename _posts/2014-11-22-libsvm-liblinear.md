...
虽然搞清楚了两者主要的区别，但我在刚刚接触这些工具时，一直搞不清楚为什么关联很紧密的算法，为什么会有两个彼此独立的工具包。而让我更加不解的是，libsvm早在2000年就已经发布了，而liblinear直到2007年才发布第一个版本。因为根据常识，应该是先有一个简单的工具，然后逐渐增加功能，开发出更完善的工具。但是功能更加强大的libsvm却早于liblinear很久发布，要回答这问题，还得从机器学习以及SVM的历史说起。