...
早期的机器学习分类算法可以追溯到Perception（感知机）。Perception的基本思想和Logistic Regression类似，只不过是用在线学习的方法训练出一个线性分类器。Perception的作用非常有限，当时的很多问题都无法很好地解决。我们可以在[UCI数据集](https://archive.ics.uci.edu/ml/datasets.html) 中看到一些80年代到90年代初期用于机器学习研究的数据。